...
module Data_int : DATA with type t = int
module Data_bool : DATA with type t = bool
module Data_float : DATA with type t = float
module Data_string : DATA with type t = string
...
module Typeable_of_data (A : DATA) : TYPEABLE with type t = A.t
